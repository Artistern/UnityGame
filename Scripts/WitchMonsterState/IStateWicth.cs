...
public class IStateWicth:MonoBehaviour
{
    protected WitchControl mMonsterControl;
    ...
    protected WitchBattleControl mWitchBattleControl;

    public IStateWicth(WitchControl monsterControl)
    {
