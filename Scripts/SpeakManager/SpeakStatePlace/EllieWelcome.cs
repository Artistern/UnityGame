...
public class EllieWelcome : TalkManager
{
    ...
    public EllieWelcome(SpeakStateControl speakState)
    {
    ...
    {
        TextAsset tryTextAsset = Resources.Load("NPCSpeaker/对话测试") as TextAsset;
    ...
    public override void UpdateXml()
    {
        if (Input.GetKeyDown(KeyCode.C))
        {
            ...
            {
                //mSpeakStateControl.SetSpeakGroup(new NPCChoice(mSpeakStateControl));
                isEnd = true;
            }
        }
    }
